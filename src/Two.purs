...
data ProgState = ProgState IntCodeProg IP Status
...
runProg :: Partial => IntCodeProg -> IntCodeProg
runProg p = runProg' (ProgState p 0 Running)
  where runProg' ps@(ProgState m _ Halted) = m
        runProg' ps@(ProgState _ _ Running) = runProg' $ step ps
...
data Input = Input {noun :: Int, verb :: Int, mem :: IntCodeProg}
data Result = Result {noun :: Int, verb :: Int, mem :: IntCodeProg}
